...
#define kPopupWindowIMG          [UIImage imageNamed:@"rate.png"]
...
- (void)setupViews
{
    ...
    _progressAccountIMG.frame = CGRectMake(-25, 0, 50, 30);
...
- (void)setSubviewsFrame
{
    ...
    [UIView animateWithDuration:self.rateProgressView.progress animations:^{
        self.progressAccountIMG.frame = CGRectMake(self.bounds.size.width * self.rateProgressView.progress - 25, 0, 50, 30);
